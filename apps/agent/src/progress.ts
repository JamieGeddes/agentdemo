...
export function stepLabelForTool(name: string): string {
  const labels: Record<string, string> = {
    ...
    list_activity: "Reviewing what I did",
    // DeepWiki MCP
    ...
    assignTicket: "Assigning the ticket",
    ...
    showTriageBoard: "Building the triage board",
    showRelatedTickets: "Correlating related tickets",
    showActivityRecap: "Summarizing the session",
    proposeTicketActions: "Proposing a triage plan",
